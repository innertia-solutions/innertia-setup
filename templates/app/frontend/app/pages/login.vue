    ...
    <form class="space-y-4" @submit.prevent="handleSubmit" novalidate>
      <div>
        ...
        <input
          ...
          class="py-2 sm:py-2.5 px-3 block w-full border border-slate-200 rounded-lg sm:text-sm placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-transparent dark:border-slate-700 dark:text-slate-300 dark:placeholder:text-white/60 dark:focus:ring-slate-600"
        />
      </div>
